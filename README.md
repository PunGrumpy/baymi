...
- **Monday 10:00 UTC, cost watchdog**: last week's turns and tokens against the week before, read back from the agent's own wide events. Needs a PostHog project; without one the other three still run
